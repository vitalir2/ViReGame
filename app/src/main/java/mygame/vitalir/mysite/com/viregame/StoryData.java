/*
If I want to do quest next time, I'll get a xml or json file to write this data
 */
...
public class StoryData {
    ...
    public final String[] cardNames = {"Это начало пути. Вашему персонажу предстоит выбраться " +
            ...
            "Поднявшись на верхний этаж, вы замечаете несколько разбитых игрушек и маленькую девочку," +
                    " стоящую посреди зала",
            "Близко к выходу подземелья вы обнаруживаете запертого в клетке торговца, предлагающего " +
                    "вам за спасение все чего вы попросите",
            "Вы доходите до выхода из подземелья, и рядом с ним замечаете владельца подземелья," +
                    " жестокого императора Вопрака, который вре это время наблюдал за вами"};
    ...
    public final String[][] cardChoiceTexts = {{"Хорошо", "Хорошо", "Хорошо"},
            ...
            {"Не обращать внимание и обойти", "Подойти и утешить", "Выстрелить в нее"},
            {"Попросить чего-то, что может вылечить", "Попросить денег", "Проигнорировать торговца"},
    ...
    public final String[][] cardChoiceResults = {{"", "", ""},
            ...
            {"Обойдя зал, вы нашли в одной из разбитых ваз флакон с зельем лечения.",
                    "Подойдя к девочке, она превратилась в ужасного оборотня. Вам удалось отбиться," +
                            " но это оставило след в вашей паамяти.", "Ваш выстрел помог разобраться" +
                    " с девочкой, оказавшейся оборотнем, без особых проблем."},
            {"Вы освободили торговца и он дал вам пару флаконов леченияю",
                    "Вы освободили торговца и он дал вам горсть золотых монет.",
                    ""},
